...
class TestRangeOperations:
    ...
    async def test_write_and_read_range(self, eval_run, excel_server):
    ...
    async def test_clear_range(self, eval_run, excel_server):
...
class TestSheetOperations:
    ...
    async def test_create_and_list_sheets(self, eval_run, excel_server):
...
class TestTableOperations:
    ...
    async def test_create_table(self, eval_run, excel_server):
...
class TestConditionalFormatSelection:
    ...
    async def test_selects_color_scale(self, eval_run, excel_server):
        """LLM should pick add_color_scale for gradient formatting."""
        agent = _make_eval(excel_server, "cf-color-scale", allowed_tools=_CF_TOOLS)
    ...
    async def test_selects_data_bar(self, eval_run, excel_server):
        """LLM should pick add_data_bar for bar chart formatting."""
        agent = _make_eval(excel_server, "cf-data-bar", allowed_tools=_CF_TOOLS)
    ...
    async def test_selects_cell_value_format(self, eval_run, excel_server):
        """LLM should pick add_cell_value_format for value-based rules."""
        agent = _make_eval(excel_server, "cf-cell-value", allowed_tools=_CF_TOOLS)
    ...
    async def test_selects_contains_text(self, eval_run, excel_server):
        """LLM should pick add_contains_text_format for text matching."""
        agent = _make_eval(excel_server, "cf-text", allowed_tools=_CF_TOOLS)
...
class TestDataValidationSelection:
    ...
    async def test_selects_list_validation(self, eval_run, excel_server):
        """LLM should pick set_list_validation for dropdown lists."""
        agent = _make_eval(excel_server, "dv-list", allowed_tools=_DV_TOOLS)
    ...
    async def test_selects_number_validation(self, eval_run, excel_server):
        """LLM should pick set_number_validation for numeric constraints."""
        agent = _make_eval(excel_server, "dv-number", allowed_tools=_DV_TOOLS)
...
class TestCommentOperations:
    ...
    async def test_add_comment(self, eval_run, excel_server):
...
class TestMultiStepWorkflows:
    ...
    async def test_write_and_format(self, eval_run, excel_server):
...
class TestLargeDataResponse:
    ...
    async def test_populate_and_summarize(self, eval_run, excel_server):
